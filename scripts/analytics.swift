...
func fetchData(endpoint: String, apiKey: String) -> [Visitor]? {
...
func retrieveAPIKeyFromKeychain() -> String? {
    let query: [String: Any] = [
        ...
        kSecAttrService as String: keyChainItemKey,
...
let keyChainItemKey = "orjpap.github.io.analytics.apiKey"
let keyChainUser = "orjpap"

guard let apiKey = retrieveAPIKeyFromKeychain() else {
    fatalError("No API key \(keyChainItemKey) found in keychain")
}

if let visitors = fetchData(endpoint: endpoint, apiKey: apiKey) {
